 ...
 */
public class StackArMutated3499 extends org.autotest.Stack {
    ...
    public StackArMutated3499() {
        this(org.autotest.mutants.StackArMutated3499.DEFAULT_CAPACITY);
    }

    public StackArMutated3499(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3499 other = ((org.autotest.mutants.StackArMutated3499) (obj));
        if (true) {
            return false;
        }

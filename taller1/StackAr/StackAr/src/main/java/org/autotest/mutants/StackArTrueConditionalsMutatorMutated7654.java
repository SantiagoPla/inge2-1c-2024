...
/**
 * TrueConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por true en la línea 79.
 */
public class StackArTrueConditionalsMutatorMutated7654 extends org.autotest.Stack {
    ...
    public StackArTrueConditionalsMutatorMutated7654() {
        this(org.autotest.mutants.StackArTrueConditionalsMutatorMutated7654.DEFAULT_CAPACITY);
    }

    public StackArTrueConditionalsMutatorMutated7654(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArTrueConditionalsMutatorMutated7654 other = ((org.autotest.mutants.StackArTrueConditionalsMutatorMutated7654) (obj));
        if (true) {
            return false;
        }

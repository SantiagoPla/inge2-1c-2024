...
public class RegressionTest28 {
    ...
    public void test1428() throws Throwable {
        ...
        org.junit.Assert.assertEquals(obj43.toString(), "[true]");
        org.junit.Assert.assertEquals(java.lang.String.valueOf(obj43), "[true]");
        org.junit.Assert.assertEquals(java.util.Objects.toString(obj43), "[true]");
        org.junit.Assert.assertTrue("'" + boolean44 + "' != '" + false + "'", boolean44 == false);
        org.junit.Assert.assertTrue("'" + int45 + "' != '" + 1 + "'", int45 == 1);
    }
